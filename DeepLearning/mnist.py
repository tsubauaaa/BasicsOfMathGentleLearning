...
# (学習に再現性を持たせるためにシードを固定している。本来は不要。)
np.random.seed(0)
...
# ---------------------------
#
# im: (画像数×チャンネル×高さ×幅)の形をした変換前画像
# fh: フィルタの高さ
# fw: フィルタの幅
# p: パディング
#
# 戻り値: (画像数分の特徴マップの縦横サイズ×フィルタのサイズ)の形をした行列
...
#
# col: col形式のデータ
# im_shape: im形式に戻した時の(画像数×チャンネル×高さ×幅)のサイズを指定
# fh: フィルタの長さ
# fw: フィルタの幅
# s: ストライド
# p: パディング
